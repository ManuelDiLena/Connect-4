      ...
      return arrayRow.map((array, columnIndex) => {
        ...
        if (array === 1) {
          return (
            <motion.svg
              className='disk'
              animate={{ top: ['0%', gridPositionRow[rowIndex] + '%'], transition: { duration: 0.5 } }}
              key={counter}
              style={{ left: gridPositionColumn[columnIndex] + '%' }}
            >
              <PLAYER1DISK height='100%' width='100%' />
            </motion.svg>
          )
        } 
        else if (array === 2) {
          return (
            <motion.svg
              ...
              style={{ left: gridPositionColumn[columnIndex] + '%' }}
            >
              <PLAYER2DISK height='100%' width='100%' />
            </motion.svg>
          )
  ...
  const hoverMark = () => {
    if (player === 1) 
      return (
        <svg 
          className='marker'
          style={{ left: (gridPositionColumn[hover] + 2.53) + '%' }}
        >
          <MARKER1 height='40' width='40' />
        </svg>
      )
    else if (player === 2)
      return (
    ...
    return winnerPos.map((pos, index) => {
      return (
        <svg
          ...
          style={{ left: (gridPositionColumn[pos[1]] + 2.22) + '%', top: (gridPositionRow[pos[0]] + 3) + '%' }}
        >
          <WINNERCIRCLE height='100%' width='100%' />
        </svg>
      )
    })
  }
  ...
  return (
    <>
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(0) }}
      >
      ...
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(1) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(2) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(3) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(4) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(5) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner && !wait) setNewDisk(6) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
