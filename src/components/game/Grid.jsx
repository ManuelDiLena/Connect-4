  ...
  return (
    <>
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(0) }}
      >
      ...
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(1) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(2) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(3) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(4) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(5) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
      ...
      <svg 
        ...
        onClick={() => { if (!winner) setNewDisk(6) }}
      >
        <rect x='0' y='0' width='85' height='528' fill='none' />
      </svg>
